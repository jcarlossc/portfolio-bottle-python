        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="index.html" id="portfolio">Portfólio <code id="python">Python</code></a>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#menuNavbar">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse" id="menuNavbar">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="teste">
                            <li class="nav-item"><a class="nav-link" id="color-link-skil" href="index.html">Início</a></li>
                        ...
                        <ul class="text-center">
                            <li class="align-menu">
                                <a href="https://www.kaggle.com/jcarlossc" id="link-7" target="_blank" alt="link-kaggle">
                                    <img src="/static/img/kaggle.svg" id="kaggle-svg" alt="Kaggle">
                                </a>
                            </li>
                            <li class="align-menu">
                                <a href="https://www.linkedin.com/in/carlos-da-costa-669252149/" id="link-7" target="_blank" alt="link-linkedin">
                            ...
                            <li class="align-menu">
                                <a href="https://github.com/jcarlossc" id="link-6" target="_blank">
                            ...
                            <li class="align-menu">
                                <a href="mailto:josecscosta@fac.pe.senac.br" id="link-6">
